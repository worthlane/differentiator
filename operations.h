...
DEF_OP(LN, "ln", 2, 1, {log(number_2)}, LatexOperationTypes::PREFIX, "\\ln", true, false,
{
...
DEF_OP(EXP, "exp", 2, 1, {exp(number_2)}, LatexOperationTypes::PREFIX, "\\exp", true, false,
{
...
DEF_OP(SIN, "sin", 2, 1, {sin(number_2)}, LatexOperationTypes::PREFIX, "\\sin", true, false,
{
...
DEF_OP(COS, "cos", 2, 1, {cos(number_2)}, LatexOperationTypes::PREFIX, "\\cos", true, false,
{
...
DEF_OP(COT, "ctg", 2, 1, {1/tan(number_2)}, LatexOperationTypes::PREFIX, "\\cot", true, false,
{
...
DEF_OP(TAN, "tg", 2, 1, {tan(number_2)}, LatexOperationTypes::PREFIX, "\\tan", true, false,
{
...
DEF_OP(ARCSIN, "arcsin", 2, 1, {asin(number_2)}, LatexOperationTypes::PREFIX, "\\arcsin", true, false,
{
...
DEF_OP(ARCCOS, "arccos", 2, 1, {acos(number_2)}, LatexOperationTypes::PREFIX, "\\arccos", true, false,
{
...
DEF_OP(ARCCOT, "arcctg", 2, 1, {M_PI/2 - atan(number_2)}, LatexOperationTypes::PREFIX, "\\arccot", true, false,
{
...
DEF_OP(ARCTAN, "arctg", 2, 1, {atan(number_2)}, LatexOperationTypes::PREFIX, "\\arctan", true, false,
{
    return _DIV(NUM(1), _ADD(NUM(1), _DEG(CPY(node->right), NUM(2))));
})
